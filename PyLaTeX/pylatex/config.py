...
The current active configuration is `pylatex.display_settings.active`. This variable can
...
class Version1:
    """The display_settings used to get the behaviour of v1.x.y of the library.
    ...
    @contextmanager
    def use(self):
        """Use the display_settings temporarily in specific context.
    ...
    def change(self, **kwargs):
        """Override some attributes of the display_settings in a specific context.

        A simple usage example::

            with pylatex.display_settings.active.change(indent=False):
                # Do stuff where indent should be False
                ...
...
class Version2(Version1):
    """The display_settings used to get the behaviour of v2.x.y of the library.
