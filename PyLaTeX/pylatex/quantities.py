...
class Quantity(Command):
    ...
    def __init__(self, quantity, *, options=None, format_cb=None):
        ...
        '\\rounded_err_val[round-precision=3]{6.022e23}'
        ...
        if isinstance(quantity, (pq.UncertainQuantity, pq.Quantity)):
            ...
            super().__init__(command='rounded_err_val', arguments=_format(quantity),
                             options=options)

        self.arguments._escape = False  # dash in e.g. \rounded_err_val{3 +- 2}
