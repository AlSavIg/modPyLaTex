...
class CommandBase(LatexObject):
    ...
    def __init__(self, arguments=None, options=None, *,
        ...
        elif extra_arguments == 'specific_package':
            self.extra_arguments = 'specific_package'
        else:
        ...
        if self.extra_arguments is None:
            return r'\{command}{options}{arguments}'\
                .format(command=self.latex_name, options=options,
                        arguments=arguments)
        elif self.extra_arguments == 'specific_package':
            return r'\{command}{arguments}{options}'\
                .format(command=self.latex_name, options=options,
                        arguments=arguments)
