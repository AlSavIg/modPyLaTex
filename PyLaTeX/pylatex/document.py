...
class Document(Environment):
    ...
    def __init__(self, default_filepath='default_filepath', *,
                 ...
                 geometry_options=None, data=None, language=None, font='tempora'):
        r"""
        Args
        ----
        ...
        indent: bool
            ...
            is `None` it will use the value from the active display_settings. Which is
            `True` by default.
        ...
        language: str
            Initial argument for babel package (english by default).
            \usepackage[language]{babel}
        font: str
            Font by default is 'tempora' because of it's multitasking: it has bold, itallic ... etc modifications in
            many languages.
        """
        ...
        if language:
            packages.append(Package('babel', options=language))
            packages.append(Package('newtxmath', options='bigdelims,vvarbb'))
        if font:
            packages.append(Package('tempora'))
