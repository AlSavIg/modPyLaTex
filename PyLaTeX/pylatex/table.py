...
class LongTable(Tabular, HasCaption):
    """A class that represents a longtable (multipage table)."""

    packages = [Package('longtable', extra_arguments='specific_package', options='=v4.13')]
    ...
    def add_caption(self, caption):
        """Add a caption to the longtable.
